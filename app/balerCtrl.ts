...
export class BalerCtrl {
    ...
    public dougTest(): void {
        this.$log.debug("top of dougTest()");
        this.refreshData();
    }
    ...
    private refreshData() {
        ...
        .then(() => {
            ...
            this.gaugeSettings.apply();
            this.$scope.$apply();
            this.gaugeSettings.refresh();
        }).done;
        ...
        this.$scope.$watch(() => {
            ...
            // this.balerData.currentWeight = this.loadCellDataService.getLoadCellWeight();
            // this.gaugeSettings.caption.value = " " + this.balerData.currentWeight;
            // this.$log.debug("currentWeight updated to: " + this.gaugeSettings.caption.value);
