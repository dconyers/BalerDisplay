...
USB_SPI_STATUS 
CP213x_SetGpioModeAndLevel      (BYTE channel, BYTE mode, BYTE level );

USB_SPI_STATUS 
CP213x_TransferReadSync         ( BYTE pReadBuf[],
                                  DWORD length,
...
USB_SPI_STATUS
CP213x_Open                     ( DWORD deviceIndex, DWORD VID, DWORD PID );

USB_SPI_STATUS 
CP213x_GetSpiControlBytes       ( BYTE controlBytes[CP213x_NUM_GPIO] );

USB_SPI_STATUS 
CP213x_SetSpiControlByte        ( BYTE channel, BYTE controlByte );

USB_SPI_STATUS
CP213x_SetChipSelect            ( BYTE channel, BYTE mode );
